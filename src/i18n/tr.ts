export const tr = {
  ...
  userProfile: {
    ...
    requestSent: 'İstek gönderildi',
    requestReceived: 'Bu oyuncudan gelen isteğin var',
    alreadyFriends: 'Arkadaşsınız',
  },
  friends: {
    title: 'Arkadaşlar',
    incomingTitle: 'Gelen istekler',
    outgoingTitle: 'Gönderilen istekler',
    friendsTitle: 'Arkadaşlarım',
    incomingEmpty: 'Bekleyen gelen istek yok',
    outgoingEmpty: 'Bekleyen gönderilen istek yok',
    friendsEmpty: 'Henüz arkadaşın yok',
    accept: 'Kabul et',
    reject: 'Reddet',
    cancel: 'İptal et',
    remove: 'Kaldır',
    removeTitle: 'Arkadaşlıktan çıkar',
    removeConfirm: (name: string) => `${name} arkadaşlarından çıkarılsın mı?`,
    loadFailed: 'Arkadaşlar yüklenemedi',
    actionFailed: 'İşlem tamamlanamadı',
    requestSentSuccess: 'Arkadaşlık isteği gönderildi',
  },
  ratingsCard: {
    title: 'Puanlar',
  ...
  series: {
    tabTitle: 'Seriler',
    listEmpty: 'Henüz bir serinin parçası değilsin.',
    loadFailed: 'Seriler yüklenemedi',
    createCta: 'Yeni seri oluştur',
    teamModeMixed: 'Karma takımlar (her hafta farklı)',
    teamModeFixed: 'Sabit takımlar',
    dayLabels: [
      'Pazar',
      'Pazartesi',
      'Salı',
    ...
    weekUnknown: 'Hafta —',
    poolHeader: 'Havuz',
    poolMembersCount: (n: number) => `${n} üye`,
    poolCapHint: 'En fazla 28 üye',
    poolEmpty: 'Henüz havuzda kimse yok.',
    authorityBadge: 'Yetkili',
    inviteCta: 'Üye davet et',
    invitePendingHeader: 'Bekleyen davetler',
    inviteApprove: 'Onayla',
    inviteReject: 'Reddet',
    memberSuggestCta: 'Yeni üye öner',
    inviteByIdLabel: 'Davet edilecek kullanıcı ID (UUID)',
    invitePlaceholder: '00000000-0000-0000-0000-000000000000',
    inviteNotesLabel: 'Not (opsiyonel)',
    inviteSubmit: 'Daveti gönder',
    inviteSent: 'Davet gönderildi.',
    inviteFailed: 'Davet gönderilemedi.',
    leavePoolCta: 'Havuzdan ayrıl',
    kickCta: 'Havuzdan çıkar',
    kickConfirm: (name: string) => `${name} havuzdan çıkarılsın mı?`,
    hideCta: 'Listemden gizle',
    unhideCta: 'Tekrar göster',
    hideOnlyIfPaused: 'Sadece duraklatılmış serileri gizleyebilirsin.',
    createTitle: 'Yeni seri',
    createTitlePlaceholder: 'Pazar Akşamı 21:00',
    createDayLabel: 'Hangi gün?',
    createTimeLabel: 'Saat',
    createDurationLabel: 'Süre (dk)',
    createCityLabel: 'Şehir (opsiyonel)',
    createDistrictLabel: 'İlçe (opsiyonel)',
    createTeamModeLabel: 'Takım modu',
    createTeamModeMixedHint:
      'Takımlar her hafta katılım sırasına göre belirlenir',
    createTeamModeFixedHint:
      'Aynı oyuncular her hafta aynı takımda oynar',
    createFixedTeamAName: 'Takım 1 adı',
    createFixedTeamBName: 'Takım 2 adı',
    createSubmit: 'Seriyi oluştur',
    createSubmitting: 'Oluşturuluyor...',
    createTitleRequired: 'Seri adı zorunlu',
    createFailed: 'Seri oluşturulamadı',
    pauseCta: 'Seriyi duraklat',
    resumeCta: 'Devam ettir',
    skipNextCta: 'Önümüzdeki haftayı atla',
    skipNextConfirm: 'Önümüzdeki haftanın maçı atlansın mı?',
    editFixedCta: 'Seri bilgilerini düzenle',
    chatCta: 'Seri sohbeti',
    chatEmpty: 'Henüz mesaj yok.',
    chatComposerPlaceholder: 'Mesaj yaz...',
    chatSend: 'Gönder',
    chatLoadFailed: 'Mesajlar yüklenemedi',
    chatSendFailed: 'Mesaj gönderilemedi',
    teamAFixedHeader: (name: string) => `Takım: ${name}`,
    fixedAssignToA: (name: string) => `${name} → A`,
    fixedAssignToB: (name: string) => `${name} → B`,
    fixedUnassign: 'Kaldır',
    transferAuthorityTitle: 'Yetkiyi devret',
    transferAuthorityConfirm: (name: string) =>
      `${name} yeni yetkili olsun mu?`,
  },
  seriesRsvp: {
    headerQuestion: 'Bu hafta katılacak mısın?',
    coming: 'Geliyorum',
    notComing: 'Gelmiyorum',
    deadlineCountdown: (h: number, m: number) =>
      `Son katılım: ${h} saat ${m} dk içinde`,
    deadlineUrgent: (m: number) => `Son katılım: ${m} dk içinde`,
    deadlinePassed: 'Katılım kapalı',
    counts: (coming: number, notComing: number, noAnswer: number) =>
      `Geliyorum: ${coming}   Gelmiyorum: ${notComing}   Cevapsız: ${noAnswer}`,
    formatPreview: (format: number) =>
      `Şu anki katılım sayısıyla maç ${format}v${format} oynanacak. Son katılım anında değişebilir.`,
    formatPreviewCancelled:
      'Şu anki katılımla maç açılamaz (en az 10 kişi gerekli).',
    locked: 'Maç kilitli — takımlar belirlendi.',
    cancelledUnderfill: 'Yetersiz katılım nedeniyle maç iptal edildi.',
    cancelledImbalance: 'Takım dengesizliği nedeniyle maç iptal edildi.',
    waitlisted:
      'Bu hafta kadro doldu. Önümüzdeki hafta için yeniden cevap vermen gerekecek — kimsenin önceliği yok.',
    confirmingError: 'Cevabın kaydedilemedi. Tekrar dene.',
  },
  seriesAuthority: {
    manageCta: 'Yönet',
    sheetTitle: 'Yetkili kontrolleri',
    close: 'Kapat',
    skipThisWeek: 'Bu haftayı iptal et',
    skipConfirm: 'Bu haftaki maç iptal edilsin mi?',
    editInstance: 'Bu haftaki maçı düzenle',
    sendReminder: 'Cevap vermeyenlere hatırlatma gönder',
    reminderSent: 'Hatırlatma gönderildi.',
    reminderRateLimited: 'Bu maç için zaten hatırlatma gönderildi.',
    forceLock: 'Kadroyu şimdi kilitle',
    forceLockConfirm:
      'Kadro şimdi kilitlensin mi? Sonradan değiştirilemez (sadece diziliş edit yapılabilir).',
    formatOverrideLabel: 'Format değiştir (küçültme)',
    formatOverrideHint:
      'Sistemin seçtiği formatı küçültebilirsin. Büyütme yapılamaz.',
    formatOverrideClear: 'Sistemin seçimini kullan',
    formatOverrideNotAvailable:
      'Henüz yeterli onay yok — format seçimi katılım dolunca açılır.',
  ...
  outcome: {
    ...
    cardDescription:
      'Sen seçilen 4 oyuncudan birisin. Doğru sonucu seç.',
    optionA: 'Takım A kazandı',
    optionB: 'Takım B kazandı',
    optionDraw: 'Berabere',
    submit: 'Gönder',
    submitConfirm: (label: string) =>
      `"${label}" olarak gönderiyorsun. Değiştirilemez.`,
    submitted: 'Sonucun gönderildi.',
    alreadyReported: 'Zaten sonuç bildirdin.',
    alreadyResolved: 'Sonuç zaten açıklandı.',
    notSelected: 'Bu maçın sonucunu bildirmek için seçilmedin.',
    resolvedHeader: 'Resmi sonuç',
    resolvedA: 'Takım A kazandı',
    resolvedB: 'Takım B kazandı',
    resolvedDraw: 'Berabere',
    resolvedNone: 'Yeterli onay alınamadı, sonuç kaydedilmedi.',
  },
  wdl: {
    stripHeader: 'Son 10 maç',
    win: 'G',
    draw: 'B',
    loss: 'M',
    summary: (w: number, d: number, l: number) => `${w}G ${d}B ${l}M`,
    empty: '',
  },
  publicSeriesBadge: 'SERİ',
  lineupEdit: {
    title: 'Dizilişi düzenle',
    save: 'Kaydet',
    saving: 'Kaydediliyor...',
    saveSummary: (n: number) => `Kaydet (${n} değişiklik)`,
    pickHint: 'Önce bir oyuncuyu seç, sonra hedef slota dokun.',
    crossTeamBlocked: 'Sabit takımlarda oyuncu diğer takıma geçemez.',
    reservesHeader: 'Yedekler',
    emptySlot: '— Boş —',
    saveFailed: 'Diziliş kaydedilemedi.',
    saved: 'Diziliş güncellendi.',
  },
} as const;
